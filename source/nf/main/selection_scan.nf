...
workflow {
    ...
    metadata_selection = PARSE_METADATA_SELECTION(params.sample_metadata, params.population_metadata, params.species_metadata, params.focal_populations, input_selection.vcf_condensed, null)
    metadata_structure = PARSE_METADATA_STRUCTURE(params.sample_metadata, params.population_metadata, params.species_metadata, params.focal_populations, input_structure.vcf_condensed, null)
