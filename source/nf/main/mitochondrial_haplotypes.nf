...
workflow {
    ...
    BCFTOOLS_NORMALISE(BCFTOOLS_INDEX.out, params.ref_genome)
    BCFTOOLS_INDEX_NORMALISED(BCFTOOLS_NORMALISE.out.normalised_vcf)
    BCFTOOLS_MAKE_CONSENSUS_FASTA(BCFTOOLS_INDEX_NORMALISED.out, params.mt_filt_indelgap, params.mt_filt_inclusions, params.ref_genome)
