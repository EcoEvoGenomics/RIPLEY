include { PLINK_INIT_PLINKFILES; PLINK_PAIRWISE_LD; PARSE_PLINK_LD_DECAY } from "../source/nextflow/modules/plink.nf"
...
workflow {
    ...
    PLOT_PLINK_LD_DECAY("${launchDir}/source/R/plot_linkage_decay.R", PARSE_PLINK_LD_DECAY.out)
